...
To reference the current release in academic publications you may use the following DOI link, which also lets you generate respective citations in common formats.
